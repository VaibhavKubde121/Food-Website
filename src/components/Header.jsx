...
const Header = ({ title, image, type }) => {
	...
	return (
		<div className="w-full h-[100vh]">
            ...
            from-black to-transparent top-0 z-8 flex flex-col 
            items-center justify-center pt-40 2xl:pt-20 px-4">
				...
				</h1>
				{
					type && (
						...
						rounded-full">Welcome to FlavorVerse, your passport to culinary adventures! {" "}
							<br className="hidden md:block" />
							Discover a treasure trove of delectable
