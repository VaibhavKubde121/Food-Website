      ...
      <div className="w-full px-4 lg:px-20 pt-5">
        <div className="flex gap-10 items-center justify-center px-4 ">
          <div className="flex flex-col justify-between">
            ...
            <p className="text-neutral-100 text-center text-[12px] md:text-md">CALORIES</p>
          </div>
              ...
              <div className='flex flex-wrap gap-4'>
                {
                  recipe?.healthLabels.map((item, index) => (
                    <p className='text-white flex items-center gap-2 bg-[#fff5f518] px-4 py-1 rounded-full ' key={index}>
          ...
          <div className='w-full md:w-2/4 2xl:pl-10 mt-20 md:mt-0'>
            {
              recipes?.hits?.length > 0 && (
                <>
                  ...
                  <div className='flex flex-wrap justify-center items-center gap-6 px-1 pt-3'>
                    {
